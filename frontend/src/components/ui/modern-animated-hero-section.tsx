...
export const ScrambledTitle: React.FC<{ items?: string[], className?: string }> = ({ items, className }) => {
    ...
    return (
        <h1
            ref={elementRef}
            className={`font-bold tracking-wider justify-center ${className || "text-4xl md:text-6xl text-white"}`}
            style={{ fontFamily: 'monospace' }}
        >
            {items ? items[0] : 'Instant Verification'}
        </h1>
    )
}
